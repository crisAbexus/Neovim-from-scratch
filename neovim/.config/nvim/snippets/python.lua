...
function TAble_of_nodes(trig)
  ...
  if (trig == black_red) then styles_code = '  \\x1b[1;30;41m' end
  if (trig == black_green) then styles_code = '  \\x1b[1;30;42m' end
  if (trig == black_yellow) then styles_code = '  \\x1b[1;30;43m' end
  if (trig == black_purple) then styles_code = '  \\x1b[1;30;45m' end
  if (trig == black_cyan) then styles_code = '  \\x1b[1;30;46m' end
  if (trig == black_white) then styles_code = '  \\x1b[1;30;47m' end
  if (trig == white_red) then styles_code = '  \\x1b[1;37;41m' end
  if (trig == white_green) then styles_code = '  \\x1b[1;37;42m' end
  if (trig == white_blue) then styles_code = '  \\x1b[1;37;44m' end
  if (trig == white_purple) then styles_code = '  \\x1b[1;37;45m' end
  if (trig == white_cyan) then styles_code = '  \\x1b[1;37;46m' end
  if (trig == red_black) then styles_code = '  \\x1b[1;31;40m' end
  if (trig == green_black) then styles_code = '  \\x1b[1;32;40m' end
  if (trig == yellow_black) then styles_code = '  \\x1b[1;33;40m' end
  if (trig == blue_black) then styles_code = '  \\x1b[1;34;40m' end
  if (trig == purple_black) then styles_code = '  \\x1b[1;35;40m' end
  if (trig == cyan_black) then styles_code = '  \\x1b[1;36;40m' end
  if (trig == gray_black) then styles_code = '  \\x1b[1;37;40m' end
  if (trig == cyan_red) then styles_code = '  \\x1b[1;31;46m' end
  return {
    d(1, function()
